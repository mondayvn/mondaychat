...
# Description: Mondaychat installation script
# OS: Ubuntu 18.04 LTS
# Script Version: 0.2
...
echo "Woot! Woot!! Mondaychat server installation is complete"
echo "The server will be accessible at http://<server-ip>:3000"
echo "To configure a domain and SSL certificate, follow the guide at https://www.monday.com.vn/docs/deployment/deploy-mondaychat-in-linux-vm"
