class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_mondaychat_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_MONDAYCHAT_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless MondaychatCaptcha.new(params[:h_captcha_client_response]).valid?
  end
